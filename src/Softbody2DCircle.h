#ifndef Softbody2DCircle_H
#define Softbody2DCircle_H
...
namespace godot
{
    class Softbody2DCircle : public Polygon2D
    {
        GODOT_CLASS(Softbody2DCircle,Polygon2D)
        private:
